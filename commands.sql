...
CREATE TABLE ADOPTED(CID INT REFERENCES CENTER(CID),PET_NAME VARCHAR(30),ADOPTER_NAME VARCHAR(30),CONTACT_INFO VARCHAR(100),DATE DATE);
CREATE TABLE MAIN_ADMIN(NAME VARCHAR(30),EMAIL VARCHAR(30),PH_NO VARCHAR(30));
...
INSERT  INTO MAIN_ADMIN VALUES("Ananth","anath@nlgj.com","9124834843");
